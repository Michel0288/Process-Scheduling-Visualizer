$(document).ready(function(){
    ...
    addbutton.onclick = function(){
        ...
        num += 1
        tablebody.innerHTML += "<tr id=Process "+ num +"><td>"+num+"</td><td>"+priority+"</td><td>"+arrival+"</td><td>"+burst+"</td><td id=Status"+ num +">Waiting</td>";
        processes.push([num, priority, arrival, burst]);
        MakeProcess(priority, arrival, burst);
    ...
    function MakeProcess(priority, arrival, burst){
        n++;
